					...
					<div>
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Connexion</a></li>
								<li><a class="dropdown-item text-primary fw-bold" href="#">Inscription</a></li>
							</ul>
						</div>
					</div>
				</li>
