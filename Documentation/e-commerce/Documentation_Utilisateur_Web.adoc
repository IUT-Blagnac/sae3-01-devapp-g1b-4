...
Afin de confirmer sa commande, l'utilisateur doit cliquer sur le bouton "passer commande". Si l'utilisateur n'est pas connecté, alors il sera renvoyé sur la page de connexion (cf. <<#inscription_et_connexion,Inscription et Connexion>>). +
