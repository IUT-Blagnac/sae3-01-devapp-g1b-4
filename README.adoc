...
- https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-4/blob/master/Documentation/IOT/Documentation_Technique_IOT.adoc[Documentation technique iot]
- https://github.com/IUT-Blagnac/sae3-01-devapp-g1b-4/blob/master/Documentation/IOT/Documentation_Utilisateur_IOT.adoc[Documentation utilisateur iot]
